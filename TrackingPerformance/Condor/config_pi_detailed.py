"""
Scan pi- sur CLD_o2_v07 perso — RECO DETAILED DIGITIZATION.
Grille : 7 énergies × 9 thetas × 10 subjobs = 630 jobs.

Pour lancer (sim déjà produite séparément) :
    python condorJobs_reco.py --config config_pi_detailed
"""
from pathlib import Path
import os

_TAG = Path(__file__).stem   # "config_pi_detailed"
...
SIM_SOURCE_TAG = "config_pi"   # SIM produites par config_mu_perso
